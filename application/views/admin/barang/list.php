    ...
    <div class="card card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?= base_url('admin/barang/add') ?>" class="btn btn-tool"><i class="fas fa-plus"></i> Add
                </a>
            </div>
            <!-- /.card-tools -->
        </div>
                    ...
                    <?php foreach ($barang as $key => $value) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('admin/barang/edit/' . $value->id_barang) ?>" class="btn btn-warning btn-xs"><i class="fas fa-edit"></i></a>
                                <button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete<?= $value->id_barang ?>"><i class="fas fa-trash"></i></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
