  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?= base_url('admin/dashboard') ?>" class="nav-link <?php if (
        ...
        <li class="nav-item">
          <a href="<?= base_url('admin/kategori') ?>" class="nav-link <?php if (
        ...
        <li class="nav-item">
          <a href="<?= base_url('admin/barang') ?>" class="nav-link <?php if (
                                                                      $this->uri->segment(2) == 'barang'
                                                                    ) echo "active"; ?>">
        ...
        <li class="nav-item">
          <a href="<?= base_url('admin/gambar') ?>" class="nav-link <?php if (
                                                                      $this->uri->segment(2) == 'gambar'
                                                                    ) echo "active"; ?>">
        ...
        <li class="nav-item">
          <a href="<?= base_url('admin/pesanan_masuk') ?>" class="nav-link <?php if (
                                                                              $this->uri->segment(2) == 'pesanan_masuk'
                                                                            ) echo "active"; ?>">
        ...
        <li class="nav-item">
          <a href="<?= base_url('admin/laporan') ?>" class="nav-link <?php if (
        ...
        <li class="nav-item">
          <a href="<?= base_url('auth/logout_user') ?>" onclick="return confirm('Yakin ingin logout ?')" class="nav-link">
