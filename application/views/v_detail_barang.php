      ...
      <div class="card-body">
          <div class="row">
              <div class="col-12 col-sm-6">
                  ...
                  <div class="col-12">
                      <img src="<?= base_url('./assets/img/' . $barang->foto) ?>" class="product-image" alt="Product Image">
                  </div>
                  <div class="col-12 product-image-thumbs">
                      <?php foreach ($gambar as $g) : ?>
                          <div class="product-image-thumb active"><img src="<?= base_url('./assets/gambar_barang/' . $g->gambar) ?>" alt="Product Image"></div>
                      <?php endforeach; ?>
                  </div>
              </div>
              <div class="col-12 col-sm-6">
